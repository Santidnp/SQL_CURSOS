...
INSERT INTO authors(author_id,name,nationality) VALUES(NULL,'Juan Rulfo','MEX'); # SE cambio '' por NULL igual lo leia como string
INSERT INTO authors(name , nationality) VALUES('Gabriel Garcia Marques', 'COL');
INSERT INTO authors VALUES(NULL,'Juan Vasquez','COL');# SE cambio '' por NULL igual lo leia como string
INSERT INTO authors(name, nationality)
VALUES('Julio Cortazar','ARG'),
('Isabel Allende','CHI'),
('Octvio Paz','MEX'),
('Juan Carlos Onetti','URU'); #Chunks de 50
...
#Los query anidados pueden causar problemas de procesamiento aumentan la complejidad del proceso
...
INSERT INTO`authors`(author_id,name) 
VALUES (6,'Octavio Paz')
ON DUPLICATE KEY UPDATE name = VALUES(name);

DELETE FROM books WHERE title = 'Vuelta al laberinto de la soledad';
...
INSERT INTO `clients`(client_id,name, email, birthdate, gender, active,created_at) VALUES(5,'Pablo Saavedra','Pablo.93733268B@random.names','1960-07-21','M',1,'2018-04-09 16:51:30'),
(6,'Marta Carrillo','Marta.55741882W@random.names','1981-06-15','F',1,'2018-04-09 16:51:30'),
(7,'Javier Barrio','Javier.54966248C@random.names','1971-04-24','M',1,'2018-04-09 16:51:30'),
(8,'Milagros Garcia','Milagros.90074144A@random.names','1964-12-05','F',1,'2018-04-09 16:51:30'),
(9,'Carlos Quiros','Carlos.63291957M@random.names','1954-08-28','M',1,'2018-04-09 16:51:30'),
...
SELECT name ,email, gender FROM clients LIMIT 10; #LIMIT siempre al final
...
DELETE FROM books WHERE author_id = 6;

source C:/Users/sngh9/OneDrive/Escritorio/SQL_platzi/all_94102478-9b9d-4111-bd3d-ba6d2c0ad791.sql #Correr un script de SQL
...
SELECT nationality ,COUNT(author_id) AS c_authors
FROM authors
WHERE nationality IS  NOT NULL #Orden de condionces de las faciles a las puntuales
...
SELECT AVG(price) AS prom, STDDEV(price) AS std , nationality
FROM books as b
JOIN authors as a
ON a.author_id=b.author_id
GROUP BY nationality;
...
SELECT AVG(price) AS prom, STDDEV(price) AS std ,COUNT(book_id) AS libros, nationality
FROM books as b
JOIN authors as a
ON a.author_id=b.author_id
GROUP BY nationality
...
TRUNCATE transactions; #borrar contenido de la tabla
...
GROUP BY nationality;
'"
## mysqldump respaldo base de datos
## alter alterar esquema de base de datso
...
# mysqldumbs esquema y datos o solo esquema
